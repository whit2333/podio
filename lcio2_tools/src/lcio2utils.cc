...
namespace lcio2 {
  ...
  IMPL::ClusterImpl*               from_lcio2(const Cluster*               c){return nullptr;}
  IMPL::SimCalorimeterHitImpl*     from_lcio2(const SimCalorimeterHit&     c){return nullptr;}
  IMPL::RawCalorimeterHitImpl*     from_lcio2(const RawCalorimeterHit&     c){return nullptr;}
  IMPL::CalorimeterHitImpl*        from_lcio2(const CalorimeterHit&        c){return nullptr;}
  IMPL::SimTrackerHitImpl*         from_lcio2(const SimTrackerHit&         h){return nullptr;}
  IMPL::TrackerHitImpl*            from_lcio2(const TrackerHit&            h){return nullptr;}
  IMPL::ReconstructedParticleImpl* from_lcio2(const ReconstructedParticle& p){return nullptr;}
  IMPL::VertexImpl*                from_lcio2(const Vertex&                p){return nullptr;}
  IMPL::TrackImpl*                 from_lcio2(const Track&                 t){return nullptr;}
  IMPL::TrackerRawDataImpl*        from_lcio2(const TrackerRawData&        t){return nullptr;}
